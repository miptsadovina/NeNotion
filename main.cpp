...
void work_with_text_window(int number_of_page);
//void work_with_text_window();
void work_with_task_window(int number_of_page, Board& board, std::vector<Board>& list_of_boards);
//void work_with_calendar_window();
...
void work_with_menu_window(int number_of_page, Board& board, std::vector<Board>& list_of_boards) {
    Window window(sf::VideoMode(height_of_window, lenght_of_window), "Menu");
    while (window.isOpen()) {
...
void work_with_board_window(int i, Board& board, std::vector<Board>& list_of_boards) {
    Window window(sf::VideoMode(height_of_window, lenght_of_window), "Board");
    while (window.isOpen()) {
        BoardPage page(window, i, board.color_ind);
        sf::Event event;
        for (int j = 0; j < board.list_of_widgets.size(); ++j) {
            board.list_of_widgets[j].draw_image(window);
        }
        while (window.pollEvent(event)) {
            if (event.type == sf::Event::Closed)
                window.close();
            ...
            if (event.type == sf::Event::TextEntered and board.add_text) {
...
void work_with_position_window(std::string page_name, int number_of_page, Board& board, std::vector<Board>& list_of_boards) {
    Window window(sf::VideoMode(height_of_window, lenght_of_window), "Positions");
    while (window.isOpen()) {
...
void work_with_calendar_window(int number_of_page, Board& board, std::vector<Board>& list_of_boards) {
    Window window(sf::VideoMode(height_of_window, lenght_of_window), "Calendar");
    sf::String task_text = board.calendar_text[board.calendar_task];
...
void work_with_picture_window(int x, int y, int number_of_page, Board& board, std::vector<Board>& list_of_boards) {
    Window window(sf::VideoMode(height_of_window, lenght_of_window), "Picture");
    while (window.isOpen()) {
        ...
        while (window.pollEvent(event)) {
            ...
            if (page.picture_1.is_pressed()) {
                ...
                board.list_of_widgets.push_back(image);
                window.close();
                work_with_board_window(number_of_page, board, list_of_boards);
            }
...
void open_main_window(std::vector<Board>& list_of_boards) {
    Window window(sf::VideoMode(height_of_window, lenght_of_window), "Main");
    while (window.isOpen()) {
//        CalendarPage page(window);
...
void work_with_color_window(int number_of_page, Board& board, std::vector<Board>& list_of_boards) {
    Window window(sf::VideoMode(height_of_window, lenght_of_window), "Colors");
    while (window.isOpen()) {
...
void work_with_task_window(int number_of_page, Board& board, std::vector<Board>& list_of_boards) {
    Window window(sf::VideoMode(height_of_window, lenght_of_window), "To do list");
    while (window.isOpen()) {
